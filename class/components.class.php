 ...
 * o componente pode ser um menu ou um rodapé
 * 
 * Este arquivo possui três classes:
 ...
 * A classe footer bar que define um rodapé para o site
 **/
...
class MenuBar{
	...
	/*
		...
		Responsável por inicializar dois arrays,
		um contendo as referências para os nomes de cada menu
...
class FooterBar{
	...
	*/
	...
	/*
		Método footer_bar()
		Responsável por montar uma barra de 
		rpdapé através de um array de labels menus e links.
	*/
